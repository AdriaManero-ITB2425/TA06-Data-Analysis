...
# Calculate the percentage change of the 'Mean' column
mean_results['PctChange'] = mean_results['TotalPrecip'].pct_change() * 100



# Print the updated DataFrame with the percentage change
print(mean_results)

print(file_count)
print(total_valores_procesados)
print(total_valores_nulos_procesados)
